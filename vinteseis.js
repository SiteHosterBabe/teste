(async function universalAutoScript() {
    ...
    console.log('[UA] Universal Auto Script (v9 - verificação completa) iniciado...');
    ...
    // Nova função que substitui todos os textos da seção "Como funciona"
    function replaceHowItWorksTexts() {
        // Título e parágrafos dos passos
        var steps = [
        ...
        steps.forEach(function(step) {
            ...
            pElements.forEach(function(p) {
                if (p.innerText.trim() === step.pText && p.innerText !== step.newP) {
                    ...
                    console.log('[UA] P substituído:', step.pText.substring(0, 30) + '...');
                }
            });
        });
    }
    ...
    function applyAllTransformations() {
        try {
            ...
            replaceHowItWorksTexts();  // Substitui todos os textos dos passos
    ...
    // Agora verificamos TODAS as transformações importantes
    // ============================================================
    function isPageFullyTransformed() {
        ...
        // Botão Cadastrar (header) removido?
        ...
        // Verificar se o título principal foi substituído
        ...
        // Verificar se a imagem hero foi substituída
        var heroImg = document.querySelector('img.Hero_heroImage__14M5B[alt="Hero Image"]');
        if (heroImg && heroImg.src && heroImg.src.includes('/home/computer.webp')) {
        ...
        // Verificar se o botão "Ver mais carros" foi modificado (pelo menos o evento, mas verificamos se o botão existe e não está original)
        ...
        if (verMaisBtn) {
            // Se ainda existe com texto original, esperamos
            console.log('[UA] Aguardando modificacao do botao Ver mais carros...');
            return false;
        }

        // Verificar se o background da seção HowItWorks foi alterado
        ...
        // Verificar se os textos dos passos foram substituídos (amostra: primeiro h2)
        ...
        // Verificar botão "Cadatre-se agora" dentro do HowItWorks
        ...
        // Para página de detalhe, verificar botão WhatsApp
        if (isDetalhePage) {
        ...
        // Para página de listagem, verificar cards transformados
    ...
    console.log('[UA] Script v9 ativo. Mascara de pagina ativa. Loader aguarda transformacoes com verificacao completa.');
})();