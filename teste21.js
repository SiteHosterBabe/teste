(async function universalAutoScript() {
    ...
    console.log('[UA] Script v36 - Loader como sobreposição, logo corrigido');

    // ============================================================
    // LOADER PREMIUM (6 segundos) - position:fixed puro, sem mascarar o DOM
    // ============================================================
    (function() {
    ...
    // ============================================================
    // REMOCAO DO LOADER (6 segundos obrigatórios)
    ...
    // Loader dura exatamente 6 segundos, depois revela o site ja modificado
