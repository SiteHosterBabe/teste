(function () {
  /* ═══════════════════════════════════════════════════════════
     PAGE PATCHER v5.1 — Paysender · footer fixo no fundo
  ═══════════════════════════════════════════════════════════ */
  ...
  function addDecorations() {
    ...
    if (!added.has('footer') && document.body) {
      ...
      foot.style.cssText =
        'position:fixed;bottom:0;left:0;right:0;' +           /* <-- fixo na base da viewport */
  ...
  console.log('%c[Paysender v5.1] ✓ Footer corrigido.', 'color:#1a1a1a;font-weight:bold;font-size:13px;background:#F5C842;padding:4px 10px;border-radius:4px;');
})();