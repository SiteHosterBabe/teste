    ...
    function applyListagem() {
        ...
        try {
            ...
            cards.forEach(function(card) {
                ...
                // 3. BOTÕES LAUDO E VÍDEO (corrigido: mobile no footer, desktop absoluto)
                ...
                if (hasPdf || hasVideo) {
                    ...
                    if (isMobileCard) {
                        // MOBILE: insere no footer (como era originalmente) com clique blindado
                        ...
                        // DESKTOP: posicionamento absoluto (original)
                    ...
                    function addButtonWithHandler(btn, handler) {
                        ...
                        if (isMobileCard) {
                            // Captura na fase de captura para garantir que o link não seja acionado
                            btn.addEventListener('click', function(e) {
                                e.preventDefault();
                                e.stopPropagation();
                                e.stopImmediatePropagation();
...
// Dentro do universalAutoScript, em qualquer lugar antes do final
...
// Intercepta cliques em links (navegação tradicional)
