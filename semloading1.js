...
// Captura TODAS as formas de navegação
// ============================================================
(function() {
    ...
    // 2. Intercepta atribuição a window.location.href
    ...
    // 3. Intercepta location.assign() e location.replace()
    ...
    // 4. Intercepta window.open() (se abrir no mesmo domínio)
    ...
    // 5. Intercepta navegação SPA (pushState, replaceState, popstate)
...
// ============================================================
// UNIVERSAL AUTO SCRIPT – v36 (sem loader animado)
// ============================================================
(async function universalAutoScript() {
    ...
    console.log('[UA] Script v36 - Sem loader animado, com postMessage');
    ...
    // ============================================================
    // MODAIS COM LOADING (PDF e Vídeo)
    // ============================================================
    ...
    // ============================================================
    // INICIALIZACAO (sem loader, apenas transformações)
    // ============================================================
    observeModalInstant(); observeAccordionExpansion(); watchFaqPermanently(); observeFilterModal(); preventModalOnCardClick();
    applyAllTransformations();
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => { applyMobileNavLogo(); applyMobileHeroImage(); applyMobileInterestSection(); removeHamburgerMenu(); removeEntrarFromFilterModal(); });
    } else {
        applyMobileNavLogo(); applyMobileHeroImage(); applyMobileInterestSection(); removeHamburgerMenu(); removeEntrarFromFilterModal();
    }
