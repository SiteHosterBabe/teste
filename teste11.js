    ...
    function applyListagem() {
        ...
        try {
            ...
            cards.forEach(function(card) {
                ...
                // 3. BOTÕES LAUDO E VÍDEO (mobile e desktop)
                ...
                if (hasPdf || hasVideo) {
                    ...
                    newContainer.style.cssText = 'display:flex;gap:8px;position:absolute;bottom:12px;left:12px;z-index:10;background:transparent;';
