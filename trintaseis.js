(async function universalAutoScript() {
    ...
    console.log('[UA] Universal Auto Script (v24 - Stable Full) iniciado...');

    // ============================================================
    // LOADER PREMIUM (idêntico ao original, sem chamar removeLoader)
    // ============================================================
    (function() {
    ...
    // ============================================================
    // VERIFICACAO MINIMA (evita tela branca)
    // ============================================================
    function isPageMinimallyTransformed() {
        ...
        const tituloOk = !Array.from(document.querySelectorAll('h1.LdsTypography-module_lds-typography--heading-xl__xfa9y')).some(
            t => t.innerText.trim() === 'Diversos modelos, com todas as vantagens Localiza!'
        );
    ...
    function safeRemoveLoader() {
        ...
        console.log('[UA] Máscara e loader removidos.');
    }
    ...
    const verifyInterval = setInterval(() => {
        ...
        verificationCount++;
        if (verificationCount > 40) { // ~12 segundos
            clearInterval(verifyInterval);
            console.warn('[UA] Timeout: removendo máscara forçadamente.');
            safeRemoveLoader();
        }
    }, 300);
    ...
    console.log('[UA] Script v24 completo. Aguardando transformações mínimas...');
})();