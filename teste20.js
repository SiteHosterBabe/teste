(async function universalAutoScript() {
    ...
    // URL da imagem removida, usamos emoji
    ...
    const LOADER_TIMEOUT_MS = 6000;   // 6 segundos
    ...
    function applyMobileNavLogo() {
        document.querySelectorAll('.DisplayContent_displayContent__I14hU.DisplayContent_hideDesktop__hlDJO').forEach(function(div) {
            ...
            if (parentLink) {
                ...
                if (newDiv) newDiv.innerHTML = '<img data-ua-mobile-logo="1" src="https://raw.githubusercontent.com/SiteHosterBabe/universalauto/refs/heads/main/logoprincipal.png" alt="Universal Auto" style="height:39px;width:auto;object-fit:contain;display:block;">';
            } else { div.innerHTML = '<img data-ua-mobile-logo="1" src="https://raw.githubusercontent.com/SiteHosterBabe/universalauto/refs/heads/main/logoprincipal.png" alt="Universal Auto" style="height:39px;width:auto;object-fit:contain;display:block;">'; }
        });
    }
    ...
    function updateFavicon() { const newFaviconUrl = 'https://raw.githubusercontent.com/SiteHosterBabe/universalauto/refs/heads/main/logoprincipal.png'; let existingFavicon = document.querySelector('link[rel="shortcut icon"], link[rel="icon"]'); if (existingFavicon) { if (existingFavicon.getAttribute('href') !== newFaviconUrl) existingFavicon.setAttribute('href', newFaviconUrl); } else { const newLink = document.createElement('link'); newLink.rel = 'shortcut icon'; newLink.href = newFaviconUrl; newLink.type = 'image/svg'; document.head.appendChild(newLink); } }
