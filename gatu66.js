(function () {
  /* ═══════════════════════════════════════════════════════════
     PAGE PATCHER v5.9 — Paysender
     Fix: card sintético inserido dentro do <div class="px-5">
          correcto + "Add Card" escondido após Confirm
  ═══════════════════════════════════════════════════════════ */
  ...
  /* ══════════════════════════════════════════════════════════
     ENCONTRAR O CONTENTOR CORRECTO (div.px-5 dentro do painel)
     É o <div class="px-5"> que fica vazio após remoção do card inicial,
     imediatamente dentro do painel "Credit or Debit Card".
  ══════════════════════════════════════════════════════════ */
  function findCardContainer() {
    /* Procura o painel principal pelo texto "Credit or Debit Card" */
    ...
    for (const panel of panels) {
      ...
      /* Dentro desse painel, o px-5 é o wrapper do card */
  ...
  function injectSyntheticCard(digits, cardType) {
    ...
    /* Insere DENTRO do px-5, não depois */
    container.appendChild(card);
    state.syntheticInjected = true;
  }

  /* ══════════════════════════════════════════════════════════
     REMOVE CARTÕES INICIAIS
  ══════════════════════════════════════════════════════════ */
  ...
  function onConfirmClick() {
    ...
    setTimeout(() => {
      ...
      showPayButton();
      hideAddCardButton();     /* ← esconde "Add Card" após confirm */
    }, 600);
  }
  ...
  console.log('%c[Paysender v5.9] ✓ Aplicado.','color:#1a1a1a;font-weight:bold;font-size:13px;background:#F5C842;padding:4px 10px;border-radius:4px;');
})();