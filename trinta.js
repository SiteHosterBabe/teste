(async function universalAutoScript() {
    ...
    console.log('[UA] Universal Auto Script (v19 - títulos e respostas FAQ corrigidos) iniciado...');
    ...
    // ============================================================
    // Mapeamento completo: pergunta original (do site) -> nova pergunta
    ...
    // Mapeamento das respostas: original (do site) -> nova resposta
    ...
    // Substitui os títulos das perguntas
    ...
    // Função principal que aplica todas as substituições do FAQ
    ...
    // ============================================================
    // OBSERVADOR PARA ABERTURA DE DETAILS (SEM FLASH)
    // ============================================================
    function observeAccordionExpansion() {
        const observer = new MutationObserver(mutations => {
            mutations.forEach(mut => {
                ...
                // Substitui títulos e respostas antes de reexibir
                replaceFaqTitles();
                replaceFaqAnswers();
    ...
    // ============================================================
    // OBSERVADOR PERMANENTE PARA PARÁGRAFOS E TÍTULOS (anti-flash adicional)
    // ============================================================
    ...
    function applySidebar(carroData) {
        ...
        container.innerHTML = '<div class="VehicleTitle_container__mDy6V">'
            ...
            + '<img src="https://universalautorepasse.com.br/wp-content/uploads/2024/10/Universal-Veiculos-e-Repasses-300x275.png" alt="Logo Universal" style="margin-top:20px;width:150px;height:auto;"></div>';
    ...
    function applyAllTransformations() {
        try {
            ...
            modifyLoginDialog();
            modifyContatoButton();
            modifyAccordionFaq(); // substituição inicial
    ...
    observeModalInstant();
    observeAccordionExpansion();   // sem flash
    watchFaqPermanently();         // observador para títulos e respostas
    ...
    console.log('[UA] Script v19 (títulos e respostas FAQ corrigidos) ativo.');
})();