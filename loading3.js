    ...
    function applyListagem() {
        ...
        try {
            ...
            cards.forEach(function(card) {
                ...
                // 3. BOTÕES LAUDO E VÍDEO (corrigido: mobile clicável)
                ...
                if (hasPdf || hasVideo) {
                    ...
                    if (isMobileCard) {
                        // MOBILE: insere no footer com estilo que garante clique
                    ...
                    function addButtonWithHandler(btn, handler) {
                        // Apenas um listener de click com prevenção de propagação
                        btn.addEventListener('click', function(e) {
                            e.preventDefault();
                            e.stopPropagation();
                            e.stopImmediatePropagation();
                            handler(); // chama showPdfModal ou showVideoModal
                            return false;
                        });
