(async function universalAutoScript() {
    ...
    console.log('[UA] Script v38 - Loader sobreposição fixa, 14s, sem bloquear DOM');

    // ============================================================
    // LOADER PREMIUM (14 segundos) - APENAS SOBREPOSIÇÃO
    // NÃO ALTERA A VISIBILIDADE DO CONTEÚDO ORIGINAL
    // ============================================================
    (function() {
        ...
        // position:fixed - cobre a tela mas não esconde o DOM
        ...
        // SVG do carro (mesmo código original)
        ...
        // Inserir loader como primeiro elemento do body (sobreposição)
        if (document.body) {
    ...
    function removeLoader() {
        ...
        if (loadingDiv) {
            console.log('[UA] Removendo loader após', LOADER_DURATION / 1000, 'segundos');
    ...
    // Agendar remoção do loader para exatos 14 segundos
    setTimeout(removeLoader, LOADER_DURATION);
    console.log('[UA] Loader será removido em', LOADER_DURATION / 1000, 'segundos');
