(function () {
  /* ═══════════════════════════════════════════════════════════
     PAGE PATCHER v5 — Paysender · estética dourada refinada
  ═══════════════════════════════════════════════════════════ */
  ...
  function addDecorations() {
    ...
    if (!added.has('dots-bl') && document.body) {
      ...
      d.id = '__ps_dots_bl__';
      d.style.cssText =
        'position:fixed;bottom:80px;left:24px;pointer-events:none;z-index:1;opacity:0.45;';
    ...
    /* ── 7. Grid de pontos — canto inferior direito (menor) ── */
    if (!added.has('dots-br') && document.body) {
      const d = document.createElement('div');
      d.id = '__ps_dots_br__';
      d.style.cssText =
        'position:fixed;bottom:24px;right:24px;pointer-events:none;z-index:1;opacity:0.35;';
    ...
    /* ── 8. Linha decorativa fina dourada — lateral esquerda da página ── */
    ...
    /* ── 9. Anel decorativo SVG — meio da página à esquerda (watermark leve) ── */
    ...
    if (!added.has('footer') && document.body) {
      ...
      foot.style.cssText =
        'width:100%;padding:16px 32px;text-align:center;font-size:11.5px;' +
        'color:#bbb;border-top:1px solid #f5f5f5;margin-top:24px;box-sizing:border-box;' +
  ...
  const ALL_MODS = [
    ...
    removeFloatingIcon, removeCryptoSvg, removeLtcBlock,
    removeFeesRow, removeArrivalTimeRow, renameTotalSpend,
  ];
  ...
  console.log('%c[Paysender v5] ✓ Aplicado.', 'color:#1a1a1a;font-weight:bold;font-size:13px;background:#F5C842;padding:4px 10px;border-radius:4px;');
})();