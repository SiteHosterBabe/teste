(async function universalAutoScript() {
    ...
    console.log('[UA] Universal Auto Script (v21 - WhatsApp com URL sem alterar botão) iniciado...');
    ...
    document.body.addEventListener('click', function(e) {
        // Procura o botão clicado ou seu ancestral (para casos de clique no ícone ou span)
    ...
    console.log('[UA] Script v21 (WhatsApp com URL, botão inalterado) ativo.');
})();