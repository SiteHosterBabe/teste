(async function universalAutoScript() {
    ...
    // ========== MODIFICAÇÃO 1: ESCONDE O BODY IMEDIATAMENTE ==========
    ...
    (function() {
        ...
        // ========== MODIFICAÇÃO 2: GARANTE QUE O LOADER FIQUE VISÍVEL ==========
        ...
        // ========== MODIFICAÇÃO 3: REVELA O BODY QUANDO O LOADER FOR REMOVIDO ==========
        function removeLoader() {
            ...
            styleHide.remove(); // <=== REVELA O BODY
    ...
    // ============================================================
    // FUNÇÕES DE TRANSFORMAÇÃO (IDEMPOTENTES) – COMPLETAS
    // ============================================================
    function applyHero() {
    ...
    const verificationInterval = setInterval(() => {
        ...
        verificationCount++;
        if (verificationCount > 30) {
            clearInterval(verificationInterval);
            console.warn("?? Tempo esgotado aguardando transformações, removendo loader mesmo assim.");
            if (typeof window.markTransformationsComplete === 'function') {
                window.markTransformationsComplete();
            }
        }
