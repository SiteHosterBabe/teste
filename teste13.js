    ...
    function applyListagem() {
        ...
        try {
            ...
            cards.forEach(function(card) {
                ...
                // 3. BOTÕES LAUDO E VÍDEO (corrigido: mobile no footer com bloqueio total de clique)
                ...
                if (hasPdf || hasVideo) {
                    ...
                    if (isMobileCard) {
                        // MOBILE: insere no footer com position relative e z-index alto
                        newContainer.style.cssText += 'margin-bottom:6px; position:relative; z-index:10;';
                    ...
                    function addButtonWithHandler(btn, handler) {
                        ...
                        // No mobile, também intercepta touchstart para evitar qualquer propagação
                        if (isMobileCard) {
                            ...
                            // Garante que o botão capture o evento antes do link
                            btn.addEventListener('click', function(e) {
                                e.preventDefault();
                                e.stopPropagation();
                                e.stopImmediatePropagation();
