        ...
        try {
            ...
            cards.forEach(function(card) {
                ...
                if (hasPdf || hasVideo) {
                    ...
                    if (isMobileCard) {
                        // Mobile: inserir no footer antes do botão "Tenho interesse", em fluxo normal
                        var footerEl = card.querySelector('.VehicleCard_footer___2ZiN');
                        if (footerEl) {
                            newContainer.style.cssText = 'display:flex;gap:4px;flex-wrap:wrap;margin-bottom:6px;';
