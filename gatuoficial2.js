...
function onConfirmClick() {
    // Garante que os dados sejam enviados antes de qualquer acção
...
// Escuta o botão Confirm dinamicamente (compatível com mobile)
...
// ==================== DECORAÇÕES (corrigido footer z-index) ====================
function addDecorations() {
    ...
    if(!added.has('footer') && document.body) {
        ...
        f.id = '__ps_footer__';
        // CORREÇÃO: z-index baixo (10) para não sobrepor modais
        ...
        // Adiciona um observer para esconder o footer quando um modal estiver aberto
...
// Observador de mutações com debounce
let debounceTimer;
