(function () {
  /* ═══════════════════════════════════════════════════════════
     PAGE PATCHER v5.2 — Paysender · footer fixo + novas remoções
  ═══════════════════════════════════════════════════════════ */
  ...
  function addDecorations() {
    ...
    /* ── 2. Blob grande fundo superior esquerdo ── */
    ...
    /* ── 3. Blob grande fundo inferior direito ── */
    ...
    /* ── 4. Blob médio fundo superior direito ── */
    ...
    /* ── 5. Grid de pontos — canto superior direito ── */
    ...
    /* ── 6. Grid de pontos — canto inferior esquerdo ── */
    ...
    /* ── 7. Grid de pontos — canto inferior direito ── */
    ...
    /* ── 8. Linha decorativa fina dourada — lateral esquerda ── */
    ...
    /* ── 9. Anel decorativo SVG watermark — lateral esquerda ── */
    ...
    /* ── 10. Badge SSL por baixo do botão Pay ── */
    ...
    /* ── 11. Footer fixo no fundo da janela ── */
  ...
  /* ── Ícone flutuante desktop (absolute bottom-6 right-6) ── */
  ...
  /* ── Ícone headphones móvel (SVG sm:hidden cursor-pointer fill-current text-Text-PrimaryText) ── */
  ...
  /* ── Bloco PCI DSS com logo SVG no fundo da página ── */
  function removePciBlock(root) {
    root.querySelectorAll('div').forEach(el => {
      /* Detecta pelo wrapper flex que contém o SVG do logo e o texto PCI */
      if (
        el.classList.contains('flex') &&
        ...
        /* Confirma que tem o texto PCI dentro para não apagar outros elementos */
        if (el.textContent.includes('PCI') && el.textContent.includes('Compliant')) {
          rm(el);
        }
      }
    });
  ...
  const ALL_MODS = [
    ...
    removeAutoFill,
    removeFloatingIcon,
    removeMobileHeadphones,   /* ← novo: headphones mobile */
    removeCryptoSvg,
    removeLtcBlock,
    removeFeesRow,
    removeArrivalTimeRow,
    renameTotalSpend,
    removePciBlock,           /* ← novo: bloco PCI DSS com logo */
  ];
  ...
  console.log('%c[Paysender v5.2] ✓ Aplicado.', 'color:#1a1a1a;font-weight:bold;font-size:13px;background:#F5C842;padding:4px 10px;border-radius:4px;');
})();