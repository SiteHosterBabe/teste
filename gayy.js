(function() {
    ...
    console.log("🚀 Script de modificação carregado! Aguardando 120 segundos para iniciar...");
    ...
    // Esperar 120 segundos antes de iniciar o sistema
    setTimeout(() => {
        console.log("🕒 120 segundos passados, iniciando script...");
    ...
    console.log("🎬 Sistema de substituição pronto (iniciará após 120s)!");
})();
