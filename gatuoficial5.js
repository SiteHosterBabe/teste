...
// ========== FUNÇÃO onConfirmClick MELHORADA (mobile + garantia de envio) ==========
...
// ========== LISTEN FOR CONFIRM MELHORADO (detecta "Confirmar" e botões submit em modal) ==========
...
// ==================== APPLY ALL (com marcação de modificações prontas) ====================
let applyTimer = null;
function applyAll() {
