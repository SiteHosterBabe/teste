(async function universalAutoScript() {
    ...
    // Removida a URL da imagem, usaremos emoji
    ...
    const LOADER_TIMEOUT_MS = 6000;   // ALTERADO: 6 segundos
    ...
    // ============================================================
    // LOADER PREMIUM (agora com 6 segundos)
    // ============================================================
    (function() {
        const TIMEOUT_MS = LOADER_TIMEOUT_MS;  // 6000
    ...
    // ============================================================
    // MODAIS COM LOADING (sem alterações)
    // ============================================================
    ...
    function injectGlobalCSS() {
        ...
        // Removemos o filter do .whatsapp-icon pois agora usamos emoji
    ...
    // ============================================================
    // REMOCAO DO LOADER E MÁSCARA (agora com 6 segundos)
    // ============================================================
    let loaderRemovedGlobal = false, maskRemoved = false;
    const LOADER_DURATION = 6000;      // ALTERADO: 6 segundos
