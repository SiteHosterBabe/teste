(async function universalAutoScript() {
    ...
    console.log('[UA] Script v38 - Interceptação segura de navegação');
    ...
    // ============================================================
    // INTERCEPTAÇÃO DE NAVEGAÇÃO (segura, sem redefinir propriedades não configuráveis)
    // ============================================================
    ...
    // 2. Intercepta popstate (voltar/avançar) - mostra loader imediatamente
    window.addEventListener('popstate', function() {
        notifyParent();
    });

    // 3. Intercepta pushState e replaceState para SPAs (apenas notifica)
    (function() {
