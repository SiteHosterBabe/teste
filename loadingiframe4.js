(async function universalAutoScript() {
    ...
    console.log('[UA] Script v36 - Navegação com loader antecipado');

    // ============================================================
    // NOTIFICACAO DE NAVEGACAO (postMessage para iframe pai)
    // com atraso para garantir que o loader apareça antes da navegação
    // ============================================================
    ...
    // Função de navegação com delay para dar tempo ao loader
    function notifyAndNavigate(url, delayMs = 100) {
        notifyParent();
        setTimeout(function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        if (link && link.href && link.href.startsWith(location.origin)) {
            e.preventDefault();
            notifyAndNavigate(link.href);
        }
    }, true);

    // Intercepta pushState / replaceState (SPA navigation)
    var _push = history.pushState;
    var _replace = history.replaceState;
    history.pushState = function() {
        notifyParent();
        // Não podemos atrasar pushState diretamente, então apenas notificamos.
        // O loader já estará visível quando o novo estado for renderizado.
    ...
    // ============================================================
    // MODAIS COM LOADING (mesmo código original)
    // ============================================================
    ...
    // ============================================================
    // FUNÇÕES AUXILIARES DE TRANSFORMAÇÃO (mesmo código original)
    // ============================================================
    function applyHero() {
    ...
    // ============================================================
    // FUNÇÃO PRINCIPAL DE LISTAGEM (mesmo código original)
    // ============================================================
    ...
    // ============================================================
    // SIDEBAR (PÁGINA DE DETALHES) - mesmo código original
    // ============================================================
    ...
    // ============================================================
    // PÁGINA DE DETALHES - MOBILE (mesmo código original)
    // ============================================================
